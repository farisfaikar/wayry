...
export default function CountSentence({ className = "" }: CountSentenceProps) {
  ...
  return (
    <div className={className}>
      <CountButton
        className="flex h-full w-full flex-col gap-2 text-wrap p-10 pt-7 text-center text-3xl font-bold"
      ...
      <Button variant="link" className="mt-5 flex gap-2 px-0" onClick={goToHome}>
        <MoveLeft /> Back
      </Button>
    </div>
  )
